...
public class Principal {
    ...
    private static void jogarPartidas(int numPartidas, int numJogadores) {
        ...
        for (int i = 0; i < numPartidas; i++) {
            ...
            System.out.println(jogo.valores/jogo.contagem + " média de nós explorados, " + (((double)i+1)/numPartidas)*100 + "% concluído." );
        }
        System.out.println(media/numPartidas + " média gera l de nós explorados");
